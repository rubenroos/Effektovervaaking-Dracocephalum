...
filepath <- "C:/Users/ida.mienna/OneDrive - NINA/Dokumenter/Prosjekter/Survey123_R_data/Survey123_data/Unprocessed/Effektovervaaking_GRUK_2024_results.zip"

## Path to folder where the processed directories and files should be exported
outputpath <- "C:/Users/ida.mienna/OneDrive - NINA/Dokumenter/Prosjekter/Survey123_R_data/Survey123_data/Processed/"
...
renames <- list(
  ...
  cover_vegetation_total = 'tot_dekning',
  ...
  cover_species = c('sp_dekning','dekning %'),
  
  
  cover_plants = c('karplanter_feltsjikt', 'dekning % av karplanter i feltsjikt'),
  cover_plants_summed = 'tot_dekning', 
  cover_bryophytes = 'bunnsjikt_dekning',
  cover_litter = 'stroe_dekning',
  cover_rock = 'grus_stein_berg_fjell_dekning', 
  cover_bare_soil = 'jord_dekning', 
  cover_crust = 'crust_dekning',
